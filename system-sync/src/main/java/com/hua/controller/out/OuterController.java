/**
  * @filename OuterController.java
  * @description  
  * @version 1.0
  * @author qye.zheng
 */
package com.hua.controller.out;
 ...
 */
@Controller
@RequestMapping(UriConstant.OUT + "access")
public final class OuterController extends BaseController
{
