...
public final class OuterAccessTest extends BaseTest {
	 ...
	 */
	@Test
	public void testOutAccess() {
		try {
			// 页面/服务 地址
			String url = "/out/access/login";
			// 请求构建器
			// get 方法
			...
			// 设置鉴权头部信息
			requestBuilder.header(X_AUTH_HEADER, X_AUTH_VALUE);
			/*
			 * 设置请求参数
			 */
