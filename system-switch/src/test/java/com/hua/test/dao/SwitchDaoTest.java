 ...
 */
// for Junit 4.x
public class SwitchDaoTest extends BaseSpringTest {
	...
	public void testGetByCode() {
		try {
			//
			String code = "1001-00";
			SwitchEntity entity = switchDao.getByCode(code);
			System.out.println(entity.getDescription());
		} catch (Exception e) {
			log.error("testGetByCode =====> ", e);
		}
	}
	 ...
	 */
	@Test
	public void testGetSwitchValue() {
		try {
			//
			String code = "1001-02";
			boolean flag = switchDao.getSwitchValue(code);
			log.info("testGetSwitchValue =====> flag = " + flag);
		} catch (Exception e) {
			log.error("testGetSwitchValue =====> ", e);
		}
	}
