...
@ContextConfiguration(locations = {
		"classpath:conf/xml/spring-cache.xml", "classpath:conf/xml/spring-common.xml", 
		"classpath:conf/xml/spring-config.xml", "classpath:conf/xml/spring-mvc.xml",
		"classpath:conf/xml/spring-orm.xml"}
)
@Transactional
